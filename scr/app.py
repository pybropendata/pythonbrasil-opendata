...
def main():
    ...
    st.sidebar.info(
        "Esse é um projeto de código aberto que aceita contribuições, comentários e ajuda, toda ajuda é bem vinda"
        "Você encontra o código fonte no seguinte repositório [pybr2020opendata](https://github.com/gabubellon/pybr2020opendata)"
        "Esse projeto também agracede a MarcSkovMadsen por manter o [awesome-streamlit](https://github.com/MarcSkovMadsen/awesome-streamlit)."
        "Algumas partes de códigos e dicas vem diretamente dessa excelente curadora, recomendamos também contribuir com esse projeto"
    )
